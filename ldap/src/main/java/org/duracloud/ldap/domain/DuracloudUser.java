 ...
 *         Date: 1/3/13
 */
public class DuracloudUser extends BaseDomainData {
    ...
    private void checkNotBlank(String field, String value)
    ...
    */
    ...
    public boolean equals(Object o) {
        ...
        if (securityQuestion !=
            null ? !securityQuestion.equals(that.securityQuestion) :
            that.securityQuestion != null) {
            return false;
        }
        if (securityAnswer !=
            null ? !securityAnswer.equals(that.securityAnswer) :
            that.securityAnswer != null) {
            return false;
        }
    ...
    */
    ...
    public int hashCode() {
        ...
        result = 31 * result +
            (securityQuestion != null ? securityQuestion.hashCode() : 0);
        result = 31 * result +
            (securityAnswer != null ? securityAnswer.hashCode() : 0);
        return result;
    }
